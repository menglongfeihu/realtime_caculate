...
public class WordCountTopology {
    ...
    public static void main(String[] args) //throws Exception
    {
        ...
        //注册一个bolt并订阅sentence发射出的数据流，shuffleGrouping方法告诉Storm要将SentenceSpout发射的tuple
        //随机均匀的分发给SplitSentenceBolt的实例
        ...
        //builder.setBolt(COUNT_BOLT_ID, countBolt).fieldsGrouping( SPLIT_BOLT_ID, new Fields
        //("word"));

        //WordCountBolt单词计数器设置4个Executeor(线程)
        builder.setBolt(COUNT_BOLT_ID, countBolt, 4).fieldsGrouping(SPLIT_BOLT_ID, new Fields(
                "word"));
